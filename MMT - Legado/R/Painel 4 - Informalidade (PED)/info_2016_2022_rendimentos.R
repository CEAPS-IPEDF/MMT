...
arq_2016_select <- dplyr::select(.data = arq_2016, FATOR,
                           AAMM, SIT, F210 = Q290, F220 = Q300, POS = POSDF, F470 = Q421, F481 = Q422, F270 = Q280, F280 = Q280)
...
ped <- rbind(arq_2016_select_1,arq_2016_2017_select,arq_2018_2022_select)
# 
# #### Tratamento dos arquivos 2016-2017
# 
# sql = paste0('DB_CODEPLAN.ped.NovaPEDDF', 2016:2017)
...
# # TABELA 18 - Parte 1: criação das categorias Assalariados Privados, Assalariados Públicos e outros ----
 ...
 rend_assalariados_priv_pub<-rend_real_med(arquivo=ped_arq_tab_18, var="POS_PRIV_PUB",categorias = c("Ano/mês","Assalariados Pub.","Assalariados Priv.","Outros"), periodo="anual")
