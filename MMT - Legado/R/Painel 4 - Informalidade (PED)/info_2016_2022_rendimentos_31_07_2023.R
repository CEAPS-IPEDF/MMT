...
ped_2016_encadeada_teste <- ped_2016_encadeada %>% 
  mutate(anual=case_when(!is.na(fator_anual)~1,TRUE~0))

table(ped_2016_encadeada_teste$anual,ped_2016_encadeada_teste$aamm)
