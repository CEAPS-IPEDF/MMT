...
dados <- dplyr::left_join(dados_2012,
                          ...
                          by = "cboocupacao2002") %>%
  left_join(dados_periodo2012_2020, by = "cboocupacao2002") %>%
...
dados_tec <- dplyr::left_join(dados_2012_tec,
                              ...
                              by = "cboocupacao2002") %>%
  left_join(dados_periodo2012_2020_tec, by = "cboocupacao2002") %>%
  left_join(dados_periodo2012_2021_tec, by = "cboocupacao2002")
...
rm(list = ls()[-match("base_variacao", ls())])

# Adicionando os nomes de CBOs ----
# nomes cbos
estrutura_cbo <- readRDS('produto/rds/estrutura-cbo.rds')
# bind
base_variacao <- left_join(base_variacao, estrutura_cbo, by = "cboocupacao2002")

# Salvando Base ----
readr::write_excel_csv2(base_variacao, 'produto/csv/base-cbos-variacao-sal-vinc.csv')
