...
# bind
base_variacao_final <- left_join(base_variacao_final, estrutura_cbo, by = "cboocupacao2002")

readr::write_excel_csv2(base_variacao_final, 'produto/csv/base-cbos-tipo-emprego-variacao.csv')
