#### Scrip gera dados de variação de salário e de vículos no período 2012 - 2021 por CBO
...
rais <- rais %>% filter(referencia != 2011, cbo_tec == 1, !is.na(cboocupacao2002))
...
readr::write_excel_csv2(base_variacao_final, 'produto/csv/base-ranking-cbo-tec.csv')
